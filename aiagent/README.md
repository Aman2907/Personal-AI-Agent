# Orbit AI AI Personal Assistant

Orbit AI is a Next.js personal assistant dashboard that connects communication tools, generates AI briefings, tracks alerts, and provides an assistant chat experience over synced app data.
